...
// project: optional umbrella name for version grouping on the Sources table
...
module.exports = {
  ...
  "0x0c1a3db07304d2e4e551ab4a7b083382a33f25ad": {
    ...
    project: "The Build Report",
    category: "community",
    note: "Buy-and-burn receiver (SwapAndBurn); CLAWD→dead in its txs attributed here",
  },
  "0x8c81caeca48f521df24b65f1c22c11150830f088": {
    name: "CLAWD DCA v1",
    project: "CLAWD DCA",
    category: "community",
    note: "Legacy CLAWD DCA deployment; no executed CLAWD burns observed yet",
  },
  ...
  "0x24d4e699d5a7758ba6a943243ab9bed9e8911cff": {
    name: "Clawd & Effect",
    project: "Clawd & Effect",
    category: "community",
    note: "Tip pass-through (tip→winner); tipper→dead burns inside its txs attributed here",
  },
};
