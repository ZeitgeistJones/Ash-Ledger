// Evidence-backed label suggestions.
//
// Soft-applied on the public dashboard (name + category) until confirmed in
// /admin. Soft labels render with an asterisk. Approving writes a Redis override
// and drops the asterisk; rejecting removes the soft label. Keep addresses
// lowercase and include concise, verifiable evidence.
//
// project: umbrella name for Sources-table version grouping
...
module.exports = {
  ...
  "0xe94b4b5a7a0a98cf9ed303a9c6d2d4ad7e5ef423": {
    suggestedName: "Clawd Meme Contest (latest)",
    project: "Clawd Meme Contest",
    suggestedCategory: "clawdbotatg",
  ...
  "0x708c357d6c81b9ddc4505ee5f7f730ba83316b47": {
    suggestedName: "Clawd Meme Contest (earlier)",
    project: "Clawd Meme Contest",
    suggestedCategory: "clawdbotatg",
  ...
  "0x3ae6af15c2699ab4f39394c58cbdd829a1d31f59": {
    suggestedName: "Clawd Meme Contest (prior)",
    project: "Clawd Meme Contest",
    suggestedCategory: "clawdbotatg",
  ...
  "0x70bcbd61a797013edc795408743325323fc2406c": {
    suggestedName: "Leftclaw Services (earlier)",
